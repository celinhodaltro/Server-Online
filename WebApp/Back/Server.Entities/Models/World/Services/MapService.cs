...
public class MapService : IMapService
{
    ...
    public void ReplaceGround(Location.Structs.Location location, IGround ground)
    {
    ...
    public ITile GetFinalTile(Location.Structs.Location location)
    {
    ...
    public bool GetNeighbourAvailableTile(Location.Structs.Location location, ICreature creature, ITileEnterRule rule,
        out ITile foundTile)
    {
        foundTile = null;
