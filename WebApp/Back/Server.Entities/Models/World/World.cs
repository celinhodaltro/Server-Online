...
using Server.Entities.Models.Helpers;
...
public class World
{
    ...
    public bool TryGetTile(ref Location.Structs.Location location, out ITile tile)
    {
        tile = null;
    ...
    public bool TryGetTown(Location.Structs.Location location, out ITown town)
    {
    ...
    public bool TryGetWaypoint(Location.Structs.Location location, IWaypoint waypoint)
    {
