...
public class Sector
{
    ...
    public ITile GetTile(Location.Structs.Location location)
    {
...
public readonly ref struct SpectatorSearch
{
    ...
    public Location.Structs.Location CenterPosition { get; }
    public bool Multifloor { get; }

    public SpectatorSearch(ref Location.Structs.Location center, bool multifloor, int minRangeX, int maxRangeX, int minRangeY,
    ...
    private static MinMax GetRangeZ(Location.Structs.Location center, bool multifloor)
    {
