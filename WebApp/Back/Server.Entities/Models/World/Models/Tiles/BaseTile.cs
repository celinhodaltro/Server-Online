...
public abstract class BaseTile : ITile
{
    ...
    public Location.Structs.Location Location { get; private set; }

    public void SetNewLocation(Location.Structs.Location location)
    {
    ...
    protected void SetTileFlags(IItem item)
    {
        ...
        if (item.Metadata.HasFlag(ItemFlag.Hangable)) 
