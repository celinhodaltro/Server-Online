...
using Server.Entities.Models.Location.Structs.Helpers;
...
public class StaticTile : BaseTile, IStaticTile
{
    ...
    {
        SetNewLocation(new Location.Structs.Location((ushort)coordinate.X, (ushort)coordinate.Y, (byte)coordinate.Z));
        Raw = GetRaw(items);
